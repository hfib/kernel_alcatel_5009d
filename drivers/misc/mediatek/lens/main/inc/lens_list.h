...
//begin add by liaokesen 20180301 for <TCL_W2020_A01-88> add FP5510AAF driver
#ifdef CONFIG_MTK_LENS_FP5510AAF_SUPPORT
#define FP5510AAF_SetI2Cclient FP5510AAF_SetI2Cclient_Main
#define FP5510AAF_Ioctl FP5510AAF_Ioctl_Main
#define FP5510AAF_Release FP5510AAF_Release_Main
extern void FP5510AAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long FP5510AAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int FP5510AAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//end add by liaokesen 20180301 for <TCL_W2020_A01-88> add FP5510AAF driver
