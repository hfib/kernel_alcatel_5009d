...
static struct LCM_setting_table lcm_initialization_setting_V3[] = {
	...
	{0X31, 1, {0X00}},	//2 Dot modify to column 2018-2-6
	//begin xiaopei gamma  according  2 dot to column 2018-2-7
	{0X40, 1, {0X10}},
	{0X41, 1, {0X55}},
    {0X42, 1, {0X03}},
	{0X43, 1, {0X09}},
	...
	{0X51, 1, {0X68}},
	{0X52, 1, {0X00}},
	{0X53, 1, {0X4E}}, //xiaopei when flash vcom need to block	
	
	{0X60, 1, {0X07}},	//Source Timing Adjust1 (SDTI)
	{0X61, 1, {0X00}},	//Source Timing Adjust2 (CRTI)
	{0X62, 1, {0X0a}},	//Source Timing Adjust3 (EQTI)
	...
	{0XCE, 1, {0X23}},
	{0XCF, 1, {0X00}},
	//end xiaopei gamma  according  2 dot to column 2018-2-7
	...
	{0Xe1, 1, {0X79}},
	{0X26, 1, {0Xb2}},
	//{0X06, 1, {0X10}},//xiaopeo modify gamma2018-2-7
	{0Xb3, 1, {0X10}},
...
{ 
   ...
   params->physical_height=PHYSICAL_HIGHT;
	...
	params->dsi.horizontal_backporch				= 20;//40
	params->dsi.horizontal_frontporch				= 80;//150
	params->dsi.horizontal_active_pixel 			= FRAME_WIDTH;
    //Beign xiaopei add ESD 3-27
...
{
   	//begin xiaopei  2017-12-06 first  LCM supply  ID pin is LOW 
   SET_RESET_PIN(1);
	MDELAY(10);
	SET_RESET_PIN(0);
	MDELAY(10);
...
LCM_DRIVER ili9806e_dsi_vdo_fwvga_drv = {
	.name = "ili9806e_dsi_vdo_helitech",
