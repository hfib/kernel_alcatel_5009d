...
UINT32 HI556_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by w2020 front camera
UINT32 HI846_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by w2020 rear camera
/*MT*/
...
UINT32 GC5025A_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by w2020 front camera
UINT32 GC8034_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add by w2020 front camera
/*SP*/
...
#endif
#if defined(HI556_MIPI_RAW) //add by w2020 front camera
    {HI556_SENSOR_ID, SENSOR_DRVNAME_HI556_MIPI_RAW, HI556_MIPI_RAW_SensorInit},
#endif
#if defined(HI846_MIPI_RAW) //add by w2020 rear camera
...
#endif
#if defined(GC5025A_MIPI_RAW) //add by w2020 front camera
    {GC5025A_SENSOR_ID, SENSOR_DRVNAME_GC5025A_MIPI_RAW, GC5025A_MIPI_RAW_SensorInit},
#endif
#if defined(GC8034_MIPI_RAW) //add by w2020 front camera
