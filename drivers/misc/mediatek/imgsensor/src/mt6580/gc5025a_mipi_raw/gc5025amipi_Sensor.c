...
//INFO&WB
    for(index=0;index<2;index++)
    {
        ...
        case 0x01:
            ...
            {
                LOG_INF("GC5025A_OTP_WB Check sum %d Error !!\n", index + 1);
            }
            break;
        case 0x02:
        case 0x03:
        ...
        case 0x01:
            ...
            {
                LOG_INF("GC5025A_OTP_GOLDEN Check sum %d Error !!\n", index + 1);
            }
            break;
        case 0x02:
        case 0x03:
...
#ifdef GC5025AOTP_FOR_CUSTOMER
    if ((1 == otp_info_check_flag) && (1 == otp_awb_check_flag)) {
        gc5025a_gcore_update_wb();
        lct_camera_set_proc_otpinfo_flag(1, 1);
    } else {
        printk(KERN_ERR "%s:%d: info or awb otp data check failed! otp_info_check_flag=%d otp_awb_check_flag=%d\n", __func__, __LINE__, otp_info_check_flag, otp_awb_check_flag);
    }
#endif
...
static kal_uint32 open(void)
{
    ...
    lct_camera_set_proc_camera_name(1, "TSP", "GC5025A");
