	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
			...
			mdelay(5);
                   ...
                   && (0 == strcmp(SENSOR_DRVNAME_HI556_MIPI_RAW, currSensorName))) {
            ...
            mdelay(1); //t3-2 = 2400mclk
                   ...
                   && (0 == strcmp(SENSOR_DRVNAME_GC5025A_MIPI_RAW, currSensorName))) {
            //mtkcam_gpio_set(pinSetIdx, CAMLDO, 1);
            /* First Power Pin low and Reset Pin Low */
            ...
            mdelay(1); //t8 = 25mclk
                   ...
                   && (0 == strcmp(SENSOR_DRVNAME_GC8034_MIPI_RAW, currSensorName))) {
            /* First Power Pin low and Reset Pin Low */
            if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
                mtkcam_gpio_set(pinSetIdx, CAMPDN,
                                pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
            ...
            if (TRUE != _hwPowerDown(VCAMAF)) {
                PK_DBG
                    ("[CAMERA SENSOR] Fail to OFF digital power (VCAMAF), power id = %d\n",
                     VCAMAF);
                goto _kdCISModulePowerOn_exit_;
            }
