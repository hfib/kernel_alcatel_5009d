...
// Modify.
#define TP_TYPE_X    (0x10)
#define TP_TYPE_Y    (0x57)
/*modify by swb for include third tp 20180301 */
...
static u16 _DrvMpTestItoTestSelfICChooseTpType(void)
{
    ...
    else if (TP_TYPE_Y == nTpType) // Modify. /*modify by swb for include third tp 20180301 begin*/
    {
        if (g_ChipType == CHIP_TYPE_MSG22XX)   
        {
