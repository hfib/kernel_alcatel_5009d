...
int32_t card_slot_init_device_name(void)
{
	...
	if(card_slot_device != NULL){
		printk("card_slot already created\n");
		return 0;
	}
...
/*END: Added by zhufeng, 20171206 add sdcard slot bit detect*/
