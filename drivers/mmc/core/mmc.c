...
//Added by zhufeng 20171214 for emmc proc node
...
static int mmc_decode_cid(struct mmc_card *card)
{
	...
	/*BEGIN: Added by zhufeng 20171214 for emmc proc node*/
	char emmc0_id[] = "FE12MB";
	char emmc1_id[] = "FE62MB";
	char emmc2_id[] = "EHACD8";  //add by zhufeng 20180119 for second emmc proc node
	char emmc0_name[] = "samsung KMFE10012M_B214 16+1";
	char emmc1_name[] = "samsung KMFE60012M_B214 16+1";
	char emmc2_name[] = "kingston 16EMCP08_EL3DT527 16+1";  //add by zhufeng 20180119 for second emmc proc node
	char emmc_unknow[] = "K4P8G304EQ-AGC2";
	/*END: Added by zhufeng 20171214 for emmc proc node*/
	...
	case 1: /* MMC v1.4 */
		...
		printk("zhufeng: card->cid.prod_name: %s card->cid.manfid:%d \n", card->cid.prod_name, card->cid.manfid);
		/*BEGIN: Added by zhufeng 20171214 for emmc proc node*/
		...
		{
			strcpy(card->cid.prod_version,emmc2_name);  //add by zhufeng 20180119 for second emmc proc node
		}
		else
		{
